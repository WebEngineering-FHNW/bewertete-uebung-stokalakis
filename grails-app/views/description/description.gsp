      ...
      <div class="container">
         <div class="jumbotron transparent">
            ...
            <p class="lead">The MusiQ App allows you to create and
               ...
               and you can stop the playback and skip or delete certain songs.
            </p>
         </div>
            ...
            <div class="row marketing">
               <div class="col-lg-6">
                  ...
                  <p>Partying with friends. All the boys want to connect to the
                     ...
                     devices to connect to the UE BOOM is painful and time-consuming.
                  </p>
                  <h4>Solution</h4>
                  <p>
               ...
               <div class="col-lg-6">
                  ...
                  <p>The bigger idea behind this is to be able to use a MusiQ
                     ...
                     not needed at all (master device itself acts then as a webserver).
                  </p>
